...
namespace EIV.OData.Client.Operation
{
    ...
    public sealed class DeleteOperation<T> : ODataOperation<T>, IDeleteOperation where T : class
    {
        ...
        public DeleteOperation(IODataServiceContext context)
        {
            this.entity = null;
            this.entitySet = null;
        ...
        public override IODataResponse Execute()
        {
            ...
            HttpResponseMessage response = _httpClient.DeleteAsync(query).Result;
